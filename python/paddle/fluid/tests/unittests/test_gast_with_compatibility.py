...
class TestPythonCompatibility(unittest.TestCase):
    ...
    # This problem is the bug of gast on python3.8, which has benn 
    # fixed by upgrading the version of gast. But this problem 
    # doesn't affect the use of paddle, only affects the following 
    # tests. Therefore, the following tests are disabled on python3.8.
    #
